...
from computing.STAC_specs import generate_STAC_layerwise_collection_new_URL
...
def generate_stac_spec():
    ...
    layer_obj_and_name = {
        ...
        "water_balance_fortnightly_vector": {
            "dataset_name": "Hydrology",
            "layer_name": "deltaG_fortnight_dist_block",
        },
        "natural_depressions_raster": {
        ...
        "slope_percentage_raster": {
            ...
            "layer_name": "dist_block_slope_percentage_raster",
        },
    }
    ...
    active_tehsils = TehsilSOI.objects.filter(
        ...
        district__state__state_name__iexact="Uttar Pradesh"
    ...
    for tehsil in active_tehsils:
        ...
        if (tehsil.tehsil_name == 'Balrampur'):
            ...
            for layer_name_to_generate_raster in layer_names_to_generate_rasters:
                if layer_name_to_generate_raster == "land_use_land_cover_raster":
                    lulc_year_range = ["2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024"]
                    for year in lulc_year_range:
                        print("year = ",year)

                        try:
                            is_raster_stac_generated = (
                                generate_STAC_layerwise_collection_new_URL.generate_raster_stac(
                    ...
                    try:
                        is_raster_stac_generated = generate_STAC_layerwise_collection_new_URL.generate_raster_stac(
                            state=state.state_name,
                            district=district.district_name,
                            block=tehsil.tehsil_name,
                            layer_name=layer_name_to_generate_raster,
            ...
            for layer_name_to_generate_vector in layer_names_to_generate_vectors:
                try:
                    is_vector_stac_generated = generate_STAC_layerwise_collection_new_URL.generate_vector_stac(
                        state=state.state_name,
                        district=district.district_name,
                        block=tehsil.tehsil_name,
